...
public class MatrixDataGenerator {
	public static void main(String[] args) throws RestException {
		...
		SmootherAlgoResponse sar = rt.doExchange(HttpMethod.POST, "smoother-algo", "/smoother-algo/jacobi/3","bulkSize=50000", md, SmootherAlgoResponse.class);
		System.out.println(dimention + "," +(sar.getTimeTookMilli() / 3) + "," + ((double)sar.getAvgIterationsTime() / 1_000_000d));
		dimention *= 10;
		}
